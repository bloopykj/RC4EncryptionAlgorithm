This is a proect that utilizes RC4 stream cipher encryption to read a file (named input.txt) encrypts it using an pseudo random number generator, XORs it with
